...
/* قائمة ثابتة اختيارية مبدئية */
const BASE_ITEMS = ["موس فرنسي فانيليا", "موس فرنسي شوكولاتة"];
...
const FrenchMousse = () => {
  ...
  /* Collections */
  const ordersRef = collection(db, "frenchMousseOrders");
  const itemsRef  = collection(db, "frenchMousseItems");
