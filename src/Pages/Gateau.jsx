...
/* قائمة ثابتة مبدئية (يمكن تركها فارغة أو تقليلها) */
const BASE_ITEMS = ["جاتوه فانيليا", "جاتوه شيكولاتة"];
...
const Gateau = () => {
  ...
  /* Collections */
  const ordersRef = collection(db, "gateauOrders");
  const itemsRef  = collection(db, "gateauItems");   // يحتفظ بأسماء الأصناف
    ...
    <div className="factory-page" dir="rtl">
      ...
      <div className="form-row">
        ...
        <select value={unit} onChange={e=>setUnit(e.target.value)}>
          ...
          <option>بلاكة</option><option>صاج</option><option>سيرفيز</option>
        </select>
