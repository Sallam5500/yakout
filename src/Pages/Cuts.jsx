...
/* قائمة ثابتة ابتدائية (يمكن تركها فارغة) */
const BASE_ITEMS = ["سواريه ساده", " سواريه مكسرات"];
...
const Cuts = () => {
  ...
  /* Collections */
  const ordersRef = collection(db, "cutsOrders");
  const itemsRef  = collection(db, "cutsItems");
    ...
    <div className="factory-page" dir="rtl">
      ...
      <div className="form-row">
        ...
        <select value={unit} onChange={e=>setUnit(e.target.value)}>
          <option>عدد</option><option>بلاكه</option>
          <option>سيرفيز</option><option>برنيكه</option><option>صاج</option>
        </select>
