...
import {
  collection, addDoc, onSnapshot, query, where, getDocs, runTransaction,
  serverTimestamp, deleteDoc, doc, setDoc, orderBy   // ⭐️ أضفنا orderBy
...
const StreetOut = () => {
  ...
  /* سجل الصادر (مرتب تصاعديًا بالتاريخ/الوقت) */
  useEffect(() => {
    const q = query(outCol, orderBy("timestamp", "asc"));   // يوم 1 ثم 2 ثم 3 ...
