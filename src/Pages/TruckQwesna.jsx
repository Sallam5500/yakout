...
const TruckQwesna = () => {
  ...
  useEffect(() => {
    const stored = localStorage.getItem("truckQwesna");
    if (stored) {
  ...
  useEffect(() => {
    localStorage.setItem("truckQwesna", JSON.stringify(items));
  }, [items]);
  ...
  return (
    <div className="factory-page" dir="rtl">
      ...
      <h2 className="page-title">🚛 تحميل محل قويسنا</h2>
